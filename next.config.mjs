        ...
        headers: [
          {
            ...
            value: `
              ...
              connect-src 'self' https://www.creatorscore.app https://creatorscore.app https://auth.privy.io wss://relay.walletconnect.com wss://relay.walletconnect.org wss://www.walletlink.org https://*.rpc.privy.systems https://explorer-api.walletconnect.com https://pulse.walletconnect.org https://api.web3modal.org https://api.coinbase.com;
              worker-src 'self';
              manifest-src 'self'
            `
              .replace(/\s+/g, " ")
